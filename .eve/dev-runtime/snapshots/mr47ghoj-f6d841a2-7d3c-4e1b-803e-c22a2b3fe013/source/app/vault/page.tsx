...
import { TierReserve } from '@/components/TierReserve'
  ...
  return (
    <div className="py-14">
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          {v.tiers.map((t) => (
            ...
            >
              ...
              <TierReserve tier={t.name} cta={t.cta} highlight={t.highlight} />
            </div>
          ))}
        </div>
      ...
      <section id="waitlist" className="border-t border-border py-14">
        ...
        <EmailCapture headline="Get founding access to the Vault" sub="First in, best price, and the real systems the moment they’re ready." source="vault" />
