    ...
    <div className="py-14">
      ...
      <div className="mt-16 rounded-2xl border border-accent/30 blueprint glass p-7">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <a href={`${site.github}/tree/main/standard`} className="inline-block rounded-lg bg-accent px-5 py-2.5 text-sm font-semibold text-white hover:opacity-90">
            Get the spec + template →
          </a>
          <Link href="/architect" className="inline-block rounded-lg border border-border px-5 py-2.5 text-sm font-semibold text-ink hover:border-accent">
            Generate mine with The Architect
          </Link>
        </div>
        <p className="mt-5 text-sm text-muted">
          Agent-native already? The <a href={`${site.github}/tree/main/packages/reality-md-mcp`} className="text-accent hover:underline">reality-md MCP server</a>{' '}
          gives Claude Code, Claude Desktop, and Cursor read/write access to your file:{' '}
          <code className="rounded bg-surface px-1.5 py-0.5 font-mono text-xs">claude mcp add reality-md -- npx -y reality-md-mcp</code>
        </p>
      </div>
