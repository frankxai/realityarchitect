    ...
    <>
      ...
      <section className="blueprint -mx-5 px-5 py-20 sm:py-28">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link href="/architect" className="rounded-lg bg-accent px-6 py-3 font-semibold text-bg hover:opacity-90">
        ...
        <p className="mt-4 text-sm text-muted">
          A live agent diagnoses your system gap and generates your{' '}
          <span className="font-mono text-accent">reality.md</span> — free, two minutes. It&apos;s the method, running.
        </p>
      </section>
      ...
      <section className="border-t border-border py-16">
        ...
        <p className="mt-3 max-w-2xl text-muted">
          ...
          Exhibit A: <Link href="/architect" className="text-accent hover:underline">The Architect</Link> — a durable
          agent on this very site, built with the method, wired to real storage, generating real artifacts.
        </p>
