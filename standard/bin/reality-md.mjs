...
import { readRealityMd, emit, emitAll, nextArtifactBrief, briefToMarkdown, migrate, detectVersion, LEVELS, TARGETS } from '../src/index.mjs'
...
const VALUE_FLAGS = new Set(['--target', '--write'])
const files = []
...
Flags
  --target <${TARGETS.join('|')}>   emit target (default: all)
  --json                     machine-readable output
  --write <path>             write the result instead of printing it
